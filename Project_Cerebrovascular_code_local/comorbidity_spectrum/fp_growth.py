...
class Fp_growth():
    ...
    def generate_L(self, data_set, min_support):
        ...
        for i in freqItemSet:  # 将频繁项根据大小保存到指定的容器L中
            if len(i) > max_l: max_l = len(i)  # 获取频繁集中最长频繁项的长度
    ...
    def generate_R(self, data_set, min_support, min_conf):
        ...
        return rule_list, L, support_data
...
if __name__ == "__main__":
    ...
    save_path = "dataset/" + filename.split(".")[0] + "_fpgrowth.txt"
